...
R package **mrdrivers**, version **3.0.1.9001**
...
Koch J, Soergel B, Leip D, Benke F, Dietrich J (2024). _mrdrivers: Create GDP and Population Scenarios_. R package version 3.0.1.9001, <https://pik-piam.github.io/mrdrivershttps://github.com/pik-piam/mrdrivers>.
...
@Manual{,
  ...
  year = {2024},
  note = {R package version 3.0.1.9001},
