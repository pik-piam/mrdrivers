...
toolGetScenarioDefinition <- function(driver = NULL, scen = NULL, aslist = FALSE) {
  ...
  scenarios <- tibble::tribble(
    ...
    "GDPpc",      "IndiaDEAs",  "WDI-MI-James",            "IndiaDEAs-SSP2",         "GDPpcIndiaDEAs",
    "GDPpc",      "IndiaHigh",  "WDI-MI-James",            "IndiaHigh-SSP2",         "GDPpcIndiaDEAs",
    # GDP scenarios
    ...
    "GDP",        "IndiaDEAs",  "-",                       "-",                      "GDPpcWithPop",
    "GDP",        "IndiaHigh",  "-",                       "-",                      "GDPpcWithPop",
    ...
    "Population", "IndiaDEAs",  "WDI-UN_PopDiv-MI",        "IndiaDEAs-SSP2-UN_PopDiv", "PopIndiaDEAs",
    "Population", "IndiaHigh",  "WDI-UN_PopDiv-MI",        "IndiaHigh-SSP2-UN_PopDiv", "PopIndiaDEAs",
    # Labour Scenarios
    ...
    "Labour",     "IndiaDEAs",  "-",                       "-",                      "LabourIndiaDEAs",
    "Labour",     "IndiaHigh",  "-",                       "-",                      "LabourIndiaDEAs",
